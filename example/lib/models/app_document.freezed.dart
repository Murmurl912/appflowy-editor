...
class _$AppDocumentImpl implements _AppDocument {
  ...
  @override
  String toString() {
    return 'AppDocument(id: $id, title: $title, content: $content, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
  ...
  Map<String, dynamic> toJson() {
    return _$$AppDocumentImplToJson(
      this,
    );
  }
}
...
abstract class _AppDocument implements AppDocument {
  const factory _AppDocument(
      ...
      required final DateTime updatedAt}) = _$AppDocumentImpl;
